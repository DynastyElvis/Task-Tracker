    ...
    >
      ...
      >
        ...
        <div class="linkContainer">
          <a href="https://twitter.com/Dev_Rono" title="twitter">
            <font-awesome-icon icon="fa-brands fa-twitter" size="xl" />
          </a>
          <a href="https://github.com/DynastyElvis" title="github">
            <font-awesome-icon icon="fa-brands fa-github" size="xl" />
          </a>
          <a href="https://www.linkedin.com/in/kipkemoi-elvis-aa3548209" title="elvis website">
            <font-awesome-icon icon="fa-solid fa-window-maximize" size="xl" />
          </a>
        </div>
        <small
          >&copy; Copyright {{ new Date().getFullYear() }}  Elvis</small
        >
      </div>
    </div>
  </Transition>
